...
contract TestOAppConf is Test, ISetup, IVoteContainer {
    ...
    function testSetOAppConf() public broadcast {
        ...
        // now we should be able to send tokens through the adapter (though they will get stuck)
